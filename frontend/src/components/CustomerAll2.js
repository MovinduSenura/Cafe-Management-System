                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                          {/* a href = Link to , a = Link, href = to */}
                                            <td><Link to={`/CustomerView/${customers._id}`}><button style={{color: "white", backgroundColor: "#F09D00", border: "none"}} type="button" className="btn btn-warning">View</button></Link></td>  
                                            <td><button type="button" className="btn btn-danger" onClick={() => handleDelete(customers._id)}>Delete</button></td>
                                        </tr>
                                    </tbody>
                                </table>
                                </td>
